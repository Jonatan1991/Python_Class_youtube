...
text = "Hola, mi nombre es midudev y me gusta programar en Python."
pattern = r"[aeiou]"
matches = re.findall(pattern, text)
print(matches)

# Una Regex para encontran las palabras man, fan y ban, pero ignora el resto

text = "man fan ban can pan ñan ran"
pattern = r"[mfb]an"
matches = re.findall(pattern, text)
print(matches)
